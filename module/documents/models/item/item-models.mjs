...
export class PTGAttachmentData extends PTGBaseItemData {
  static defineSchema() {
    return {
      ...this.rulesAutomationFields("attachment"),
      ...this.attachmentDetailFields(),
      kind: this.textField(),
      level: this.numberField(1),
      cost: this.numberField(),
...
export class PTGVassalData extends PTGBaseItemData {
  static defineSchema() {
    return {
      ...
      sourceActorName: this.textField(),
      sourceActorCategory: this.textField(),
      actorTemplate: new fields.ObjectField({ initial: {} }),
      powerHooks: new fields.ArrayField(new fields.StringField({ initial: "" }), { initial: [] }),
      currentTask: this.textField(),
      currentRisk: this.textField(),
      riskNotes: this.htmlField(),
      requestLog: new fields.ArrayField(new fields.ObjectField({ initial: {} }), { initial: [] }),
      benefit: this.htmlField(),
...
export class PTGGearQualityData extends PTGBaseItemData {
  static defineSchema() {
    return {
      ...this.rulesAutomationFields("gear-quality", "passive"),
      key: this.textField(),
      appliesTo: this.textField(),
      defaultValue: new fields.NumberField({ integer: true, initial: 0 }),
      supported: this.checkbox(),
      automationData: new fields.ObjectField({ initial: {} }),
      effect: this.htmlField(),
      description: this.htmlField(),
      notes: this.htmlField()
    };
